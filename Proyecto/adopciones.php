...
<body>
    ...
    <main>
        <img src="img/adopta1.jpg" width=40%>
        <img src="img/adopta2.jpg" width=40%>
        <img src="img/adopta3.jpg" width=40%>

        <img src="img/adopta4.jpg" width=40%>
        <img src="img/adopta5.jpg" width=40%>
        <img src="img/adopta6.jpg" width=40%>

        <img src="img/adopta7.jpg" width=40%>
        <img src="img/adopta8.jpg" width=40%>
        <img src="img/adopta9.jpg" width=40%>
